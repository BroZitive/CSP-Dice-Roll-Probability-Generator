...
public class SpecificNumberSum extends JFrame {
    ...
    private JTextField selectedNumberSum;
    ...
    public SpecificNumberSum(){
        ...
        title = new JLabel();
        title.setBounds(140,50,1100,77);
        title.setBackground(new Color(214,217,223));
        title.setForeground(new Color(0,0,0));
        title.setEnabled(true);
        title.setFont(new Font("SansSerif",0,60));
        title.setText("Probability of a Specific Number Sum");
        title.setVisible(true);
        
        answerLabel = new JLabel();
        answerLabel.setBounds(75,500,385,45);
        ...
        answerLabel.setText("Selected Number Sum:");
        ...
        selectedNumberSum = new JTextField();
        selectedNumberSum.setBounds(75,575,385,50);
        selectedNumberSum.setBackground(new Color(255,255,255));
        selectedNumberSum.setForeground(new Color(0,0,0));
        selectedNumberSum.setEnabled(true);
        selectedNumberSum.setFont(new Font("SansSerif",0,36));
        selectedNumberSum.setText("");
        selectedNumberSum.setVisible(true);
        ...
        contentPane.add(selectedNumberSum);
    ...
    private void calculate (ActionEvent evt) {
        ...
        if (selectedNumberSum.getText().toString().equals(""))
        {
            inputValue[0] = 0;
        }
        else
        {
            inputValue[0] = Integer.parseInt(selectedNumberSum.getText().toString());
        }   
        
        if ((((diceInput[5]*20)+(diceInput[4]*12)+(diceInput[3]*10)+(diceInput[2]*8)+(diceInput[1]*6)+(diceInput[0]*4)) >= inputValue[0]) && ((diceInput[5] > 0) || (diceInput[4] > 0) || (diceInput[3] > 0) || (diceInput[2] > 0) || (diceInput[1] > 0) || (diceInput[0] > 0)) && !(inputValue[0] == 0))
        {
            n = 2;
